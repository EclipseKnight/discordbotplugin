package discordbotplugin.net.logger;
...
public class Logger {
	...
	public static void log(Level level, String message) {
		...
		case WARN, ERROR -> System.out.println(YELLOW_BRIGHT + "[" + level.toString() + "]" + message + RESET);
		case FATAL -> System.out.println(RED_BRIGHT + "[" + level.toString() + "]" + message + RESET);
